    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg bg-white p-4 shadow">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
          ...
          {/* Date Range Start */}
          <div>
            <label htmlFor="date-start" className="mb-1 block text-sm font-medium text-gray-700">
              Start Date
            </label>
            <input
              type="date"
          ...
          {/* Date Range End */}
          <div>
            <label htmlFor="date-end" className="mb-1 block text-sm font-medium text-gray-700">
              End Date
            </label>
            <input
              type="date"
