...
export default function OvertimeSettings() {
  ...
  return (
    <div className="space-y-6 rounded-lg bg-white p-6 shadow">
      <div>
        <h2 className="mb-2 text-xl font-semibold text-gray-900">Overtime Settings</h2>
      ...
      <div className="flex items-center justify-between border-t pt-6">
        ...
        <button
          ...
          } ${updateSetting.isPending ? 'cursor-not-allowed opacity-50' : ''}`}
        >
          <span
      ...
      <div className="border-t pt-6">
        <h3 className="mb-4 text-lg font-medium text-gray-900">Daily Limits (hours)</h3>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            <label className="mb-2 block text-sm font-medium text-gray-700">Regular Overtime</label>
            <input
              type="number"
              step="0.5"
              min="0"
              ...
              onBlur={(e) =>
                handleNumberUpdate('daily_limit_regular', e.target.value, setDailyLimitRegular)
              }
            ...
            {errors.daily_limit_regular && (
              <p className="mt-1 text-sm text-red-600">{errors.daily_limit_regular}</p>
            )}
          </div>
          <div>
            <label className="mb-2 block text-sm font-medium text-gray-700">Double Overtime</label>
            <input
              type="number"
              step="0.5"
              min="0"
              ...
              onBlur={(e) =>
                handleNumberUpdate('daily_limit_double', e.target.value, setDailyLimitDouble)
              }
              className={`w-full rounded-md border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
            ...
            {errors.daily_limit_double && (
              <p className="mt-1 text-sm text-red-600">{errors.daily_limit_double}</p>
            )}
          </div>
        </div>
      </div>
      ...
      {/* Weekly Limits */}
      <div className="border-t pt-6">
        <h3 className="mb-4 text-lg font-medium text-gray-900">Weekly Limits (hours)</h3>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            <label className="mb-2 block text-sm font-medium text-gray-700">Regular Overtime</label>
            <input
              ...
              onBlur={(e) =>
                handleNumberUpdate('weekly_limit_regular', e.target.value, setWeeklyLimitRegular)
              }
              className={`w-full rounded-md border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
            ...
            {errors.weekly_limit_regular && (
              <p className="mt-1 text-sm text-red-600">{errors.weekly_limit_regular}</p>
            )}
          </div>
          <div>
            <label className="mb-2 block text-sm font-medium text-gray-700">Double Overtime</label>
            <input
              ...
              onBlur={(e) =>
                handleNumberUpdate('weekly_limit_double', e.target.value, setWeeklyLimitDouble)
              }
              className={`w-full rounded-md border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
            ...
            {errors.weekly_limit_double && (
              <p className="mt-1 text-sm text-red-600">{errors.weekly_limit_double}</p>
            )}
          </div>
        </div>
      </div>
      ...
      {/* Submission Deadline */}
      <div className="border-t pt-6">
        <h3 className="mb-4 text-lg font-medium text-gray-900">Submission Deadline</h3>
        <div className="max-w-xs">
          ...
          <input
            ...
            onBlur={(e) =>
              handleNumberUpdate('submission_deadline', e.target.value, setSubmissionDeadline)
            }
            className={`w-full rounded-md border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
          ...
          {errors.submission_deadline_days && (
            <p className="mt-1 text-sm text-red-600">{errors.submission_deadline_days}</p>
          )}
      ...
      {/* Pay Multipliers */}
      <div className="border-t pt-6">
        <h3 className="mb-4 text-lg font-medium text-gray-900">Pay Multipliers</h3>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            <label className="mb-2 block text-sm font-medium text-gray-700">Regular Overtime</label>
            <input
              ...
              onBlur={(e) =>
                handleNumberUpdate(
                  'pay_multiplier_regular',
                  e.target.value,
                  setPayMultiplierRegular
                )
              }
              className={`w-full rounded-md border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
            ...
            {errors.pay_multiplier_regular && (
              <p className="mt-1 text-sm text-red-600">{errors.pay_multiplier_regular}</p>
            )}
            <p className="mt-1 text-xs text-gray-500">e.g., 1.5 = 150% of regular pay</p>
          </div>
          <div>
            <label className="mb-2 block text-sm font-medium text-gray-700">Double Overtime</label>
            <input
              ...
              onBlur={(e) =>
                handleNumberUpdate('pay_multiplier_double', e.target.value, setPayMultiplierDouble)
              }
              className={`w-full rounded-md border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
            ...
            {errors.pay_multiplier_double && (
              <p className="mt-1 text-sm text-red-600">{errors.pay_multiplier_double}</p>
            )}
            <p className="mt-1 text-xs text-gray-500">e.g., 2.0 = 200% of regular pay</p>
          </div>
        </div>
      </div>
