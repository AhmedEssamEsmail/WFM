        ...
        <div className="rounded-lg bg-white p-6 shadow-sm">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
              ...
              <div className="mb-1 h-6 w-56 animate-pulse rounded bg-gray-200"></div>
        ...
        {request.status === 'denied' && (
          <div className="mt-4 rounded-lg border border-orange-200 bg-orange-50 p-4">
            <p className="text-sm text-orange-800">
              This request was automatically denied because the requested leave days exceeded your
              available balance.
              {allowExceptions &&
                ' You can request an exception by clicking the "Ask for Exception" button above.'}
            </p>
          </div>
        )}
      </div>
          ...
          {request.status === 'denied' && (
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Insufficient leave balance</p>
              </div>
            </div>
          )}
