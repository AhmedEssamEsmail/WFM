        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-2 space-y-1">
            <div className="flex items-center gap-2 text-xs">
              ...
              <span className="text-gray-900 font-medium truncate">{employee.department || 'Unassigned'}</span>
            </div>
            <div className="flex items-center gap-2 text-xs">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {employee.job_title && (
              <span className="px-2 py-0.5 bg-gray-100 text-gray-700 rounded text-xs truncate max-w-[150px]">
                {employee.job_title}
              </span>
            )}
            {employee.location && (
