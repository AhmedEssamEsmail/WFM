        ...
        <div className="flex items-center gap-2 relative">
          ...
          {hasNoBreaks && schedule.shift_type && schedule.shift_type !== 'OFF' && (
            <div className="group relative inline-flex">
              ...
              <div className="pointer-events-none absolute left-full top-1/2 -translate-y-1/2 ml-12 z-50 w-80 scale-0 transition-all duration-150 group-hover:scale-100">
                <div className="bg-gray-900 text-white text-xs rounded-lg py-3 px-4 shadow-xl">
                  ...
                  <div className="absolute top-1/2 -translate-y-1/2 -left-2 w-3 h-3 bg-gray-900 transform rotate-45"></div>
                </div>
              </div>
            </div>
          )}
