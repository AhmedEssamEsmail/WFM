...
export const BUTTON_STYLES = {
  primary: 'bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-lg px-4 py-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed',
  secondary: 'bg-gray-100 hover:bg-gray-200 text-gray-900 font-medium rounded-lg px-4 py-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed',
  ...
  ghost: 'hover:bg-gray-100 text-gray-700 font-medium rounded-lg px-4 py-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed',
...
export const INPUT_STYLES = {
  default: 'block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 text-base sm:text-sm',
  error: 'block w-full rounded-md border-red-300 shadow-sm focus:border-red-500 focus:ring-red-500 text-base sm:text-sm',
  disabled: 'block w-full rounded-md border-gray-300 bg-gray-50 text-gray-500 cursor-not-allowed text-base sm:text-sm',
} as const
