...
import { agentBreakScheduleArb, nonOffShiftTypeArb, breakScheduleRuleArb } from '../generators/breakScheduleGenerators'
    ...
    fc.assert(
      fc.property(
        ...
        ({ shiftType, rules }) => {
          ...
          const hb1Time = thirds.early.start + Math.floor((thirds.early.end - thirds.early.start) / 2)
          const bTime = thirds.middle.start + Math.floor((thirds.middle.end - thirds.middle.start) / 2)
