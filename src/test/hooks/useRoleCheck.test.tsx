...
describe('useRoleCheck Hook', () => {
  ...
  describe('Error handling', () => {
    ...
    it('should log error in development when used outside AuthContext (not loading, no user)', () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith(
        'useRoleCheck must be used within AuthContext with an authenticated user'
      );
