...
describe('swapRequestsService', () => {
  ...
  describe('getSwapRequestById', () => {
    ...
    it('should throw error when swap request not found', async () => {
      ...
      await expect(swapRequestsService.getSwapRequestById(TEST_UUID_1)).rejects.toThrow('Not found')
    })
  })
  ...
  describe('updateSwapRequestStatus', () => {
    ...
    it('should set approval timestamp when provided', async () => {
      ...
      await swapRequestsService.updateSwapRequestStatus(TEST_UUID_1, 'pending_wfm', 'tl_approved_at')
  ...
  describe('deleteSwapRequest', () => {
    ...
    it('should throw error when delete fails', async () => {
      ...
      await expect(swapRequestsService.deleteSwapRequest(TEST_UUID_1)).rejects.toThrow('Delete failed')
    })
  })
  ...
  describe('clearApprovalTimestamps', () => {
    it('should clear approval timestamps', async () => {
      ...
      await expect(swapRequestsService.clearApprovalTimestamps(TEST_UUID_1)).resolves.toBeUndefined()
    })
