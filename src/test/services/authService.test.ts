...
describe('authService', () => {
  ...
  describe('signUp', () => {
    ...
    it('should throw error when sign up fails', async () => {
      ...
      await expect(authService.signUp(TEST_EMAIL, TEST_PASSWORD, TEST_NAME)).rejects.toThrow(
    ...
    it('should throw error for invalid email format', async () => {
      ...
      await expect(authService.signUp('invalid-email', TEST_PASSWORD, TEST_NAME)).rejects.toThrow(
    ...
    it('should throw error for weak password', async () => {
      ...
      await expect(authService.signUp(TEST_EMAIL, '123', TEST_NAME)).rejects.toThrow(
  ...
  describe('signIn', () => {
    ...
    it('should throw error for invalid credentials', async () => {
      ...
      await expect(authService.signIn(TEST_EMAIL, 'wrong-password')).rejects.toThrow(
    ...
    it('should throw error for non-existent user', async () => {
      ...
      await expect(authService.signIn('nonexistent@dabdoob.com', TEST_PASSWORD)).rejects.toThrow(
        'Invalid login credentials'
      );
    });
  });
  ...
  describe('updateUserProfile', () => {
    ...
    it('should throw error when update fails', async () => {
      ...
      await expect(authService.updateUserProfile(TEST_UUID, { name: 'New Name' })).rejects.toThrow(
        'Update failed'
      );
    });
